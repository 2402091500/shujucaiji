...
public class MainActivity2 extends AppCompatActivity implements BackHandledInterface {
    ...
    public NavigationView.OnNavigationItemSelectedListener navigationItemListener = new NavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(MenuItem item) {
            ...
            if (!SysApplication.isInitProxy) {
                Toast.makeText(MainActivity2.this, "请等待程序初始化完成", Toast.LENGTH_LONG).show();
                return true;
            }

            switch (id) {
                case R.id.nav_camera: {
                    Intent intent = new Intent(MainActivity2.this, QrCodeScanActivity.class);
                ...
                case R.id.nav_modify:
                    if (shp.getBoolean("enable_filter", false)) {
                        Intent intent = new Intent(MainActivity2.this, ChangeFilterActivity.class);
                        startActivity(intent);
                    } else {
                        Toast.makeText(MainActivity2.this, "请前往设置启用注入功能", Toast.LENGTH_LONG).show();
                    }
                    break;
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            MainActivity2.this.runOnUiThread(callback);
                        } catch (Exception e) {
                            rootView.post(new Runnable() {
                                @Override
                                public void run() {
        ...
        public void onCompleted(Context context, UploadInfo uploadInfo, ServerResponse serverResponse) {
            try {
                ...
                if (jsonObject.getInt("errId") == 0) {
                    ...
                    showUploadDialog(MainActivity2.this);
                } else {
                    Snackbar.make(rootView, "上传失败！", Snackbar.LENGTH_LONG).setAction("Action", null).show();
                }
            } catch (Exception e) {
...
//        final String uuid = SystemBasicInfo.getUUID(this);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                edtInput.setText("");
                Glide.with(MainActivity2.this).load(CODE_URL + "?key=" + key + "&scene=2&t=" + Math.random()).into(imageView);
            }
        });
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        showLoading("上传中");
                        FileUtil.uploadFiles(MainActivity2.this, new MyUploadDelegate(), serverUrl, "upload", Environment.getExternalStorageDirectory() + "/test.zip");
                    }
                };
                createZip(runnable);
            }
...
//    }
    ...
    public void initFloatingActionMenu() {
        ...
        shareFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showFilter(MainActivity2.this,TYPE_SHARE);
                fam.close(true);
            }
        });
        ...
        uploadFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showFilter(MainActivity2.this,TYPE_UPLOAD);
                fam.close(true);
            }
        });
        ...
        public void onClick(DialogInterface dialog, int which) {
            if (which >= 0) {
                ...
                if (which == DialogInterface.BUTTON_POSITIVE) {
                    SharedPreferenceUtils.putString(MainActivity2.this, "select_ua", index + "");
    ...
    public void showHostDialog(){
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferenceUtils.putString(MainActivity2.this, "system_host", editText.getText()+"");
        ...
        builder.setNegativeButton("清空", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.hideSoftInputFromWindow(editText.getWindowToken(), 0);
                SharedPreferenceUtils.putString(MainActivity2.this, "system_host", "");
                DeviceUtils.changeHost(((SysApplication)getApplication()).proxy,editText.getText()+"");
            }
        });
        builder.show();
